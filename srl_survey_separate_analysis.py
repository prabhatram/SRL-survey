...
##Cronbach alpha for pre survey: 0.9431252732039848
##Cronbach alpha for post survey: 0.9656026029370751


## Shapiro-Wilk for testing normality--- just for the heck of it
...
normality_pre = test_normality(pre_data_wide)
#print(normality_pre)
normality_post = test_normality(post_data_wide)
#print(normality_post)
...
for question, r in effect_sizes.items():
    print(f"Question: {question}, Rosenthal's R: {r:.5f}")
